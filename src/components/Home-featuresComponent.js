            ...
            <div className="row r2 d-none d-lg-block">
              <div className="col-10 offset-2">
                ...
                <h1>
                  ...
                  <span className="gre">ENGINEER</span> and looking for a place
                  to get your questions answered. Well your search ends here
            ...
            <Parallax className="custom-class" y={[-30, 0]} tagOuter="figure">
              <div className="row">
                <div className="col-6 offset-3 d-none d-lg-block a1i">
                  <img src={a3} alt="featureImage" className="img-fluid " />
                </div>
              </div>
            </Parallax>
            <Parallax className="custom-class" y={[30, 0]} tagOuter="figure">
              <div className="row a2">
                <div className="col col-10 offset-1 col-lg-8 offset-lg-1">
                  ...
                  <p align="justify">
                    For the students of +1 and +2, we offer a specially designed
                    test series that covers all relevant topics in time for the
                    actual JEE Mains and Advanced.{" "}
                  </p>
            ...
            <Parallax className="custom-class" y={[-30, 0]} tagOuter="figure">
              <div className="row">
                <div className="col-6 offset-3 d-none d-lg-block a3i">
                  <img src={a2} alt="featureImage" className="img-fluid " />
                </div>
              </div>
            </Parallax>
            <Parallax className="custom-class" y={[30, 0]} tagOuter="figure">
              <div className="row a4">
                <div className="col col-10 offset-1 col-lg-8 offset-lg-1">
                  ...
                  <p align="justify">
                    The tensors exam is the reputed annual mock JEE examination
                    that is conducted across South India, spanning all major
                    coaching institutes.{" "}
                  </p>
                ...
                <div className="row a1b">
                  <div className="col col-10 offset-1 col-lg-8 offset-lg-3">
                    ...
                    <p align="justify">
                      ...
                      parents, their coaching institutes, or online forums. The
                      Tensors team is passionate of helping you make the right
                      choice regarding both your dream branch and institute.
                      Explore our counselling programme to know more about how
            ...
            <Parallax className="custom-class" y={[-30, 0]} tagOuter="figure">
              <div className="row">
                <div className="col-6 offset-3 d-none d-lg-block a2i">
                  <img src={a1} alt="featureImage" className="img-fluid " />
                </div>
              </div>
            </Parallax>
            <Parallax className="custom-class" y={[30, 0]} tagOuter="figure">
            ...
            <Parallax className="custom-class" y={[-30, 0]} tagOuter="figure">
              <div className="row">
                <div className="col-6 offset-3 d-none d-lg-block a4i">
                  <img src={a4} alt="featureImage" className="img-fluid " />
                </div>
              </div>
            </Parallax>
          </div>
